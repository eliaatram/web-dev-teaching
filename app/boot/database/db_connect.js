...
const db_config = {
  user: process.env.DB_USER || "e.el-atram",
  host: process.env.DB_HOST || "127.0.0.1",
  database: process.env.DB_NAME || "netflix-clone",
  password: process.env.DB_PASSWORD || "Elia",
  port: 5432,
  max: 10,
};
...
// if you start postgresql service => connection will restart correctly => select will succeed
